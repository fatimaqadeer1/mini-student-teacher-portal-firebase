...
const teacherNavLinks = [
  ...
  { href: "/mark-attendance", label: "Mark Attendance", icon: CalendarCheck },
  { href: "/assignments", label: "Assignments", icon: BookMarked },
      ...
      <>
        <SidebarHeader>
          <div className="flex items-center justify-between">
            ...
            {userRole && <Badge variant="secondary">Teacher</Badge>}
          </div>
        </SidebarHeader>
        <SidebarContent>
          <SidebarMenu>
